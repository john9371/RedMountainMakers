                ...
                <span class="red-text text-darken-2">
                    <Col s={12} m={4}>
                        <Card title="BASIC MAKER" className="Card"><p>
                            ...
                            <Button waves='light' node='a' href='localhost:3000/Payment/?amount=40'>Join</Button>
                        </Card>
                    </Col>
                </span>
                    <span class="red-text text-darken-2">
                        <Col s={12} m={4} >
                            <Card title="FULL MAKER" className="Card"><p>
                                ...
                                <Button waves='light' node='a' href='localhost:3000/Payment/?amount=80'>Join</Button>
                            </Card>
                        </Col>
                    </span>
                    <span class="red-text text-darken-2">
